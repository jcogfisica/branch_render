...
# Importa o módulo os para capturar variáveis de ambiente
import os
...
ALLOWED_HOSTS = ['mysite-nurz.onrender.com/']
...
# A lógica abaixo permite usar SQLite no ambiente local (durante o desenvolvimento) e PostgreSQL quando em produção (Render)
if DEBUG:
